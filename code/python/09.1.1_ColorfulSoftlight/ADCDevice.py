...
########################################################################
#smbus is a code library thats being imported for use
import smbus

#Creating a new class and initializing new objects for the class
...
# Attempts to do a write and if it succeeds that means there is a device
# and  will print a device found statement
# If its unable to write to a device it will print the No device found.
        try:
            ...
            return False
# Closes the bus that was initiliazed above            
    def close(self):
        self.bus.close()
...
class PCF8591(ADCDevice):
	...
	# Two reads are rquired for this to work. This is why value is
	# assigned twice
...
# Creats the ADS7830 class and defines two different functions and assigns variables.
